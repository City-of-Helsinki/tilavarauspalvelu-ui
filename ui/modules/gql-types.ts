 ...
 * });
 */
export function useSearchFormParamsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SearchFormParamsQuery,
    SearchFormParamsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SearchFormParamsQuery, SearchFormParamsQueryVariables>(
    SearchFormParamsDocument,
    options
  );
}
export function useSearchFormParamsLazyQuery(
  ...
  return Apollo.useLazyQuery<
    SearchFormParamsQuery,
    SearchFormParamsQueryVariables
  >(SearchFormParamsDocument, options);
}
export type SearchFormParamsQueryHookResult = ReturnType<
  typeof useSearchFormParamsQuery
>;
export type SearchFormParamsLazyQueryHookResult = ReturnType<
  typeof useSearchFormParamsLazyQuery
>;
export type SearchFormParamsQueryResult = Apollo.QueryResult<
  SearchFormParamsQuery,
  SearchFormParamsQueryVariables
>;
...
export type SearchFormParamsQuery = {
  __typename?: "Query";
  units?:
    | {
        __typename?: "UnitTypeConnection";
              ...
              node?:
                | {
                    ...
                    building?:
                      ...
                      | undefined;
                    location?:
                      | { __typename?: "LocationType"; addressStreet: string }
                      | null
                      | undefined;
                    images?:
                      | Array<
