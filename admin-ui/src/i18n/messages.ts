...
const translations: ITranslations = {
  ...
  ReservationUnitEditor: {
    ...
    settings: ["Julkaisemisen asetukset"],
    ...
    publishingSettings: ["Julkaisun asetukset"],
    publishBegins: ["Näytä asiakkalle alkaen"],
    publishEnds: ["Piilota asiakkailta alkaen"],
    scheduledReservation: ["Ajasta varaaminen"],
    reservationSettings: ["Varaamisen asetukset"],
    ...
    reservationBegins: ["Varaaminen mahdollista alkaen"],
    reservationEnds: ["Varaaminen päättyy"],
