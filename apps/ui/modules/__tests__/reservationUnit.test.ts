...
describe("isReservationUnitPaidInFuture", () => {
  test("return true if active and future are paid", () => {
    const pricings = [
      constructPricing({
        begins: addDays(new Date(), 10),
        lowestPrice: 0,
  ...
  test("return true if only active is paid", () => {
    const pricings = [
      constructPricing({
        begins: addDays(new Date(), 10),
        lowestPrice: 0,
  ...
  test("return true if only future one paid", () => {
    const pricings = [
      constructPricing({
        begins: addDays(new Date(), -10),
        lowestPrice: 0,
  ...
  test("returns false if future one if paid but price is set in zero", () => {
    const pricings = [
      constructPricing({
        begins: addDays(new Date(), 10),
        lowestPrice: 0,
  ...
  test("returns false all are free", () => {
    const pricings = [
      constructPricing({
        begins: addDays(new Date(), 10),
        lowestPrice: 0,
