...
describe("getNormalizedReservationOrderStatus", () => {
  ...
  test("return correct value", () => {
    ...
    expect(getNormalizedReservationOrderStatus(input)).toBe("DRAFT");
  });
  ...
  test("return correct value", () => {
    ...
    expect(getNormalizedReservationOrderStatus(input)).toBe("PAID");
  });
  ...
  test("return correct value", () => {
    ...
    expect(getNormalizedReservationOrderStatus(input)).toBe("PAID_MANUALLY");
  });
  ...
  test("null if created", () => {
    ...
    expect(getNormalizedReservationOrderStatus(input)).toBe(null);
  });
